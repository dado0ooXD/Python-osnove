...
# Ako spajanje izvrsvamo putem operatora + mozemo da dobijemo error u sledecim slucajevima
...
# Domaci zadatak.
# Dodeliti 5 razlicitih vrednosti za 5 promenljivih razlicitog naziva (Neka u tih 5 promenljivih budu koristene razlicite metode dodeljivanja vrednosti)
# i izvrsiti print spajanja dve ili tri promenljive, kao i print tipa svake od tih promenljivih.
