# Ostvariti interakciju sa korisnikom
...
# Domaci zadatak. Koristeci input() metodu i format () metodu odraditi sledece.
# Traziti od korisnika da unese svoj broj godina, visinu i tezinu. Nakon toga napraviti novu promenljivu
